...
pref("browser.tabs.extensions.tabbar.smooth_scrolling.timeout", 250);
...
pref("browser.tabs.extensions.highlight_current.style", (new String("bold bg-3Dhighlight")).valueOf());
pref("browser.tabs.extensions.highlight_unread", true);
pref("browser.tabs.extensions.highlight_unread.style", (new String("italic")).valueOf());
...
pref("browser.tabs.extensions.tabs_min_width", 100);
...
pref("browser.tabs.opentabfor.searchbar.modifierKeyEnterBehavior", 0);
pref("browser.tabs.opentabfor.contextsearch.behavior", 1);
pref("browser.tabs.opentabfor.contextsearch.useSearchBox", true);
pref("browser.tabs.opentabfor.links.behavior", 0);
pref("browser.tabs.opentabfor.links.lockedBehavior", 1);
pref("browser.tabs.opentabfor.links.targetBehavior", 0);
...
pref("browser.tabs.opentabfor.links.block_uri.type", 2);
...
pref("browser.tabs.opentabfor.history.middleClickBehavior", 2);
pref("browser.tabs.opentabfor.goToHistoryIndex.behavior", 0);
pref("browser.tabs.opentabfor.goToHistoryIndex.middleClickBehavior", 1);
pref("browser.tabs.extensions.view_source_tab", true);
...
pref("browser.tabs.extensions.loadInBackgroundWindow", true);
pref("browser.tabs.extensions.loadInBackgroundWindow.platformNative", false);
pref("browser.tabs.extensions.loadInBackgroundWindow.platformNative.inherit", false);
...
pref("browser.tabs.extensions.show_item.newTab", false);
pref("browser.tabs.extensions.show_item.bookmarkGroup", false);
pref("browser.tabs.extensions.show_item.reloadTab", false);
pref("browser.tabs.extensions.show_item.reloadAll", false);
...
pref("browser.tabs.extensions.show_item.removeTab", false);
...
pref("browser.tabs.extensions.show_item.undoRemoveTab", false);
...
pref("browser.tabs.extensions.group.edit_simple_dragdrop", true);
...
pref("browser.tabs.extensions.group.tree.simple_operation", true);
...
pref("browser.tabs.extensions.switch_tabs_by_wheel.count", 2);
...
pref("browser.tabs.extensions.autoreload.lastInterval", 86400);
pref("browser.tabs.extensions.bypass_referrerblocker", true);
...
pref("browser.tabs.extensions.startup_action_overlay.selected_session", (new String("")).valueOf());
...
pref("browser.tabs.extensions.undo_cache.global", 20);
